...
// Lesson 28.03.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLesson2803App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLesson2803App

CLesson2803App::CLesson2803App()
{
...
// Единственный объект CLesson2803App

CLesson2803App theApp;


// Инициализация CLesson2803App

BOOL CLesson2803App::InitInstance()
{
